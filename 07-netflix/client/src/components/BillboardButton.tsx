...
export default function BillboardButton({text, theme}:BillboardButtonProps) {
  return (
    <button className={`${theme === "dark" ? "bg-blue-500/30" : null } bg-white rounded-md py-2 px-4 w-auto text-lg font-semibold flex items-center hover:bg-neutral-400 transition`}>
